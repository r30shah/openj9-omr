...
TR::RegDepCopyRemoval::makeFreshCopy(TR_GlobalRegisterNumber reg)
   ...
   if (choice.regStoreNode == NULL)
      ...
      // It is possible that the node of GlRegDep is PassThrough with regLoad child where both uses same register. In this case, it won't have the corresponding regStore.
